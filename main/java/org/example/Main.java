...
public class Main {
    public static void main(String[] args) {
        ...
        //TODO get by id
        System.out.println("clientService.findClientById().getName(LKY15) = " + planetService.findPlanetById("LKY15").getName());
        //TODO get all
        ...
        ticketService.saveTicket(
                createTicket(
                        LocalDateTime.now(),
                        createClient(1L, "Andrew"),
                        createPlanet("LKY15", "Earth"),
        ...
        //TODO get by id
        System.out.println("ticketService.findTicketById(6L) = " + ticketService.findTicketById(6L).getClient().getId());
        //TODO get all
